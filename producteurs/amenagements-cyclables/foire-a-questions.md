...
Toutes les données publiées sur [transport.data.gouv.fr](http://transport.data.gouv.fr/) sont soit sous [licence ODBL](https://doc.transport.data.gouv.fr/presentation-et-mode-demploi-du-pan/conditions-dutilisation-des-donnees/licence-odbl#conditions-particulieres-dutilisation) soit sous [licence ouverte](https://doc.transport.data.gouv.fr/presentation-et-mode-demploi-du-pan/conditions-dutilisation-des-donnees/licence-ouverte). Les bases nationales seront par conséquent soumises à ces licences. Etant donné que les bases nationales rassembleront des données en Licence Ouverte et ODbL nous adopterons la licence ODbL, plus contraignante. Les réutilisateurs auront pour responsabilité de partager en ODbL les améliorations qu'ils feront sur les données des bases nationales seulement si elles portent sur des objets de même nature, de même granularité et de même couverture géographique.
