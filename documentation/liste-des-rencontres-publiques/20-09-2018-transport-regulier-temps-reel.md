...
Aujourd’hui, selon le CEREMA (base [Passim](https://passim.info/pois/search?context\_action=list\&context\_categories=\&context\_group=\&context\_organism\_type=\&context\_organization=\&context\_schema=All\&context\_subscription=\&context\_territory=\&context\_two\_col=False\&context\_hide\_directory=False\&context\_hide\_list=False\&context\_hide\_map=False\&context\_pois\_tab=\&context\_hide\_category=False\&context\_what=\&context\_widget\_mode=)), une vingtaine de producteurs de données ont mis à disposition des API temps réel. Le plus souvent, ce sont des développements propriétaires, non standardisés.
...
Nous invitons ceux qui le souhaitent à [rejoindre le Slack de transport.data.gouv.fr](https://transportdatagouvfr.slack.com/join/shared\_invite/MjA2ODkzODQyOTk4LTE0OTg4MDUyNTktNmM2OWJmOGQwOA) pour échanger plus facilement sur ces sujets.\
