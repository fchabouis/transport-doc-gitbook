...
Adeline Richer de Forges** **(Metrocount), _C. Gebhart _(Tagmaster), Catherine Fralich (Eco-counter), Vincent Dieulesaint (Eco-counter), Laure Doidi (Eco-counter)
...
Proposition retenue : préciser le pas de temps au niveau de la borne, utiliser un champ temps_début pour préciser le moment du comptage. Si le comptage est irrégulier on peut laisser l’option de préciser le temps_fin.\
